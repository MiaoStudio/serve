...
export const fetchListAllPublish = () => (dispatch, getState) => {
  tools.ajax({
       url: '/api/article/listPublish',
       method: 'GET',
       headers:{'Content-Type':'application/json'},
       async: true,
       dataType:'json'
...
export const fetchListByIdPublish = (id) => (dispatch, getState) => {
  tools.ajax({
       url: '/api/article/listPublish?id='+id,
       method: 'GET',
       headers:{'Content-Type':'application/json'},
       async: true,
       dataType:'json'
...
export const sharecontrol = (id,type) => (dispatch, getState) => {
  tools.ajax({
