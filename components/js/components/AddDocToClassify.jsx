...
class AddDocToClassify extends React.Component {
    ...
    return (
          ...
          <div>
            ...
            <Table
              ...
              columns={columns}
              dataSource={this.props.data.doclist} />
          </div>
...
export default Form.create()(AddDocToClassify);
