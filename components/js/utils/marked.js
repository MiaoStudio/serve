...
Renderer.prototype.heading = function(text, level, raw) {
  ...
  return '<h' + level + ' id="' + escapedText + '">' +
            '<a class="anchor" href="#' + escapedText + '"><span class="octicon octicon-link"></span></a>' +
            text +
         '</h' + level + '>\n';
};
...
Renderer.prototype.tocItem = function (id, level, text) {
  ...
  return '<li class="toc-item toc-level-' + level + '"><a class="toc-link" href="#lark-' + id + '"><span class="toc-number"></span> <span class="toc-text">' + text + '</span></a></li>';
};
